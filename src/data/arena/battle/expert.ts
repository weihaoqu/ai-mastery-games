...
export const expertBattleRounds: BattleRound[] = [
  {
    ...
    winner: 'B',
    explanation: 'Prompt B references an established framework (OWASP Top 10) and instructs the AI to annotate mitigations inline. This makes the output both secure and educational. Prompt A lists specific attacks to avoid, but this deny-list approach can\'t cover every vulnerability class.',
    skill: 'specificity',
  ...
  },
  {
    ...
    promptB: {
      text: 'As a peer reviewer for a psychology journal, critique the methodology of a study that surveyed 200 students about how social media affects mental health. They found a link between usage and anxiety and are claiming it\'s causal. Please provide a thorough and detailed critique of their research methods.',
      output: 'The study has some concerns worth noting. The sample size of 200 is relatively small for this kind of research. Surveying only students limits how generalizable the findings are. Self-reported data about social media use can be unreliable. And most importantly, correlation does not equal causation — the study should be careful about making causal claims. A larger, more diverse sample and longitudinal follow-up would strengthen the findings.',
    },
    winner: 'A',
    explanation: 'Prompt A includes key methodological details (cross-sectional, Likert-scale, self-reported, single measurement) that the AI can critique specifically — identifying common method variance and the causation gap. Prompt B asks for a "thorough critique" but omits these details, producing generic observations.',
    skill: 'context',
  ...
  },
  {
    ...
    winner: 'B',
    explanation: 'Prompt B covers a broader and more sophisticated set of evasion techniques (encoding, multilingual) compared to Prompt A\'s "gradual escalation" which risks being too close to real attack patterns. Both prompts are similar length, but B\'s constraints produce a more useful and safer test suite.',
    skill: 'constraints',
  ...
  },
  {
    ...
    promptB: {
      text: 'I need you to carefully extract all the action items from some meeting notes and structure them as JSON. Each item should have an assignee field, a task field, and a deadline field. Here are the notes: "talked to dev team — sam is swamped but said he\'d try to get the API docs done, no date given. also the onboarding flow needs a redesign, probably Q2."',
    ...
    winner: 'A',
    explanation: 'Both produce similar results, but Prompt A\'s few-shot examples handle edge cases — unassigned tasks, vague deadlines, informal language — establishing consistent conventions (e.g., "Unassigned" vs "Unknown", "Unspecified" vs "Not specified") that scale to any future notes.',
    skill: 'few-shot',
  ...
  },
  {
    ...
    promptB: {
      text: 'Our app had a 30-minute outage today. We know that the CPU spiked really high, there was a deploy around the same time, the database connection pool was maxed out, and a marketing email sent a lot of users to the site. Can you analyze all of these factors step by step and figure out the root cause of this incident?',
    ...
    winner: 'A',
    explanation: 'Prompt A provides exact timestamps and metrics, enabling the AI to build a precise causal timeline that reveals the deploy is a red herring. Prompt B\'s vague "around the same time" loses the temporal ordering, leading to a wrong conclusion (blaming the deploy).',
